...
const api: ElectronApi = {
  ...
  vectorizeSliceAsset: (input) => ipcRenderer.invoke("image:vectorizeSliceAsset", input),
  vectorizeSliceSelection: (input) => ipcRenderer.invoke("image:vectorizeSliceSelection", input),
