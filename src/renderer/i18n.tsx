...
const EN: Record<string, string> = {
  ...
  "查看": "View",
  "转为 SVG": "Convert to SVG",
  "素材生成后可转 SVG": "Available after asset generation",
  "转SVG": "To SVG",
  "SVG 已生成": "SVG generated",
...
const DE: Record<string, string> = {
  ...
  "暂无页面": "Keine Seiten",
  "刷新": "Aktualisieren",
  "刷新页面数据": "Seitendaten aktualisieren",
  "页面数据已刷新": "Seitendaten aktualisiert",
  ...
  "查看": "Anzeigen",
  "转为 SVG": "In SVG umwandeln",
  "素材生成后可转 SVG": "Nach Asset-Generierung verfügbar",
  "转SVG": "Zu SVG",
  "SVG 已生成": "SVG generiert",
